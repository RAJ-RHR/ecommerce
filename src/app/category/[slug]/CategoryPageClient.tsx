...
return (
  <>
    <Head>
      <title>{decodedSlug} | Herbolife Store</title>
      <meta
        name="description"
        content={`Explore top herbal products in ${decodedSlug} category. Boost your wellness with natural care from Herbolife.`}
      />
    </Head>
    <div className="mt-20">
      <main className="p-4">
